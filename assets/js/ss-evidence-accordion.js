...
(function () {
  function renderAccordion() {
    ...
    // Normalize pathname: strip trailing slash and optional .html extension
    let normalizedPath = window.location.pathname
      .replace(/\.html?$/, "")
      .replace(/\/$/, "") || "/";

    // Map actual page routes to registry keys if they differ
    const routeMap = {
      "/bjj-classes/kids-tannersville-ny": "/kids",
      "/bjj-classes/teens-tannersville-ny": "/teens",
      "/bjj-classes/adults-tannersville-ny": "/adult-bjj",
      "/bjj-classes/hunter-ny": "/near/hunter-ny",
      "/bjj-classes/windham-ny": "/near/windham-ny",
      "/bjj-classes/haines-falls-ny": "/near/haines-falls-ny",
      "/bully-proof-jiu-jitsu-tannersville-ny": "/kids",
      "/confidence-protocol": "/kids",
      "/black-belt-concierge": "/adult-bjj"
    };

    if (routeMap[normalizedPath]) {
      normalizedPath = routeMap[normalizedPath];
    }

    const sourceIds = registry.pageMap[normalizedPath] || registry.pageMap["/"] || [];
