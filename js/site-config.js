...
(function applySenseiConfig() {
  ...
  const getLaneFromBookPath = (pathname) => {
    ...
    if (normalized === '/free-bjj-intro-tannersville-ny/kids') return 'kids';
    if (normalized === '/free-bjj-intro-tannersville-ny/teens') return 'teens';
    if (normalized === '/free-bjj-intro-tannersville-ny/adults') return 'adults';
    return '';
  };
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Keep internal /free-bjj-intro-tannersville-ny links canonical (clean URL, no tracking params).
