...
for (const phrase of ['treated like a beginner, not an inconvenience', 'appropriate partner', 'right pace']) if (!intro.toLowerCase().includes(phrase.toLowerCase())) failures.push(`Free Intro: missing "${phrase}"`);
