...
DEPLOYABLE_ROOTS = ('assets/', 'admin/', 'athlete-cross-training/', 'bjj-classes/', 'bjj-glossary/', 'blog/', 'near/', 'partials/', 'js/', 'images/', 'img/', 'fonts/', 'downloads/', 'youtube/', 'yam/', 'yams/', 'external/', 'partners/', 'social/', 'snippets/', 'sources/', 'schedule/', 'free-bjj-intro-tannersville-ny/', 'options-pricing/', 'evidence/', 'hyphen-weekend/', '413/')
ROOT_FILES = {'.htaccess', 'index.html', 'robots.txt', 'sitemap.xml', 'sitemap-core.xml', 'site-shell.html', 'nav-include.html', 'report-card.html', 'after-booking-promise.html', 'after-school.html', 'show-up-kit.html', 'contact.html', 'bjj_anatomy_game.html', 'core-promise-full.html', 'core-promise-short.html', 'birthday-parties.html', 'private-lessons.html', 'programs.html', 'options-pricing.html', 'bjj-faqs.html', 'how-class-works.html', 'parent-resources.html', 'hyphen-weekend.html'}
