...
const checks = [
  ...
  ['How Class Works', read('dist/how-class-works.html'), [loop, 'live opponent who has a real job', 'fixed technique list']],
  ['Report Card', read('dist/report-card.html'), [loop, 'next problem can be chosen from evidence']],
